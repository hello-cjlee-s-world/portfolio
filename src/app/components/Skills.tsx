  ...
  const skillCategories = [
    {
      icon: <Layout size={24} />,
      title: 'Frontend',
      skills: ['React', 'PrimeReact', 'Vuetify CSS', 'Tailwind CSS', 'Vue.js'],
      color: 'from-blue-600 to-cyan-600',
    },
    {
      icon: <Server size={24} />,
      title: 'Backend',
      skills: ['Spring Boot', 'REST API', 'Ajax', 'WebSocket', 'RabbitMQ'],
      color: 'from-green-600 to-emerald-600',
    },
    {
      icon: <Database size={24} />,
      title: 'DB',
      skills: ['PostgreSQL', 'Oracle', 'Redis', 'MySQL', 'MSSQL'],
      color: 'from-orange-600 to-red-600',
    },
    {
      icon: <Smartphone size={24} />,
      title: 'Server',
      skills: ['Ubuntu', 'RHEL', 'Window Server', 'Unix'],
      color: 'from-purple-600 to-pink-600',
    },
    {
      icon: <Wrench size={24} />,
      title: 'Tool',
      skills: ['Git',  'SVN', 'Docker', 'AWS', 'Jira','Figma'],
      color: 'from-yellow-600 to-orange-600',
    },
    {
      icon: <Code2 size={24} />,
      title: 'Language',
      skills: ['Java', 'Go', 'Python', 'JavaScript'],
